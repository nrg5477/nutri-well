...
|   [남정길](https://github.com/letsgilit)    |   공공데이터 CSV DB 업데이트, 식품 검색기능 및 영양소별 세부 검색 기능, <br> 카테고리 검색기능, 식품 상세페이지(영양소 테이블, 차트,즐겨찾기), <br> 영양 차트페이지(일일 섭취량 계산,음식 목록) 담당, 식품 이미지 크롤링    |
