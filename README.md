...
|                 **이름**                 |                                                           **업무**                                                            |
|:--------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------:|
|    [진영록](https://github.com/6worry)    |   즐겨찾기 내 인기식품 TOP4 출력 기능, 카테고리 별 분류 및 식품 검색 기능, 관련식품에 대한 대형마트 내 식품 검색기능, 오류 발견 및 테스트 총괄 및 수정,  AWS S3-EC2-RDS 연동 및 배포 담당    |
|  [남정길](https://github.com/letsgilit)   | 공공데이터 CSV DB 업데이트, 식품 이미지 크롤링, 식품 검색기능 및 영양소별 세부 검색 기능, 카테고리 검색기능, 식품 상세페이지(영양소 테이블, 차트,즐겨찾기), 영양 차트페이지(일일 섭취량 계산,음식 목록) 담당 |
